...
import travis.sutherland.lambda.FourArguments;
import travis.sutherland.lambda.OneArgument;
import travis.sutherland.lambda.ThreeArguments;
import travis.sutherland.lambda.TwoArguments;
...
public class Jooby implements Router, LifeCycle, Registry {
    ...
    public <T1> Route.Definition get(final String path, final OneArgument<T1> handler) {
        return appendDefinition(new Route.Definition("GET", path, handler));
    }

    public <T1, T2> Route.Definition get(final String path, final TwoArguments<T1, T2> handler) {
        return appendDefinition(new Route.Definition("GET", path, handler));
    }

    public <T1, T2, T3> Route.Definition get(final String path, final ThreeArguments<T1, T2, T3> handler) {
        return appendDefinition(new Route.Definition("GET", path, handler));
    }

    public <T1, T2, T3, T4> Route.Definition get(final String path, final FourArguments<T1, T2, T3, T4> handler) {
        return appendDefinition(new Route.Definition("GET", path, handler));
    }
